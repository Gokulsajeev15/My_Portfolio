        ...
        <section id="about" className="about">
            ...
            <div className="about-links">
                <a href="https://github.com/Gokulsajeev15" target="_blank" rel="noopener noreferrer">
                    <img src="/My_Portfolio/src/assets/github-mark.png" alt="GitHub" className="social-icon" />
                </a>
                <a href="https://www.linkedin.com/in/gokulsajeev/" target="_blank" rel="noopener noreferrer">
                    <img src="/My_Portfolio/src/assets/InBug-Black.png" alt="LinkedIn" className="social-icon-l" />
                </a>
            </div>
        </section>
      </>
